...
public class UtcTimeUtilTest {
	...
	public void test() {
		...
		System.out.println(
				TimeUtils.convertToTzFromLondonTz(DateTimeZone.forID("Australia/Melbourne"), "2017-11-28T04:00:00Z"));
	}
	...
	public void testParseTime() {
		String time = TimeUtils.getTimeFullOffset("2018-01-18T16:00:00", "Australia/Perth");
		System.out.println(time);
	}

	@Test
	public void testConvertTimeZ() {
		String time = TimeUtils.convertTimeZone(DateTimeZone.getDefault(), DateTimeZone.forID("Australia/Perth"), "2018-01-18T16:00:00");
		System.out.println(time);
	}
}
