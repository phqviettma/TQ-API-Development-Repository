...
public class BookingInfo implements Serializable {
	...
	public String toString() {
		return "is_confirmed=" + is_confirmed + ", comment=" + comment + ", event_id=" + event_id
				+ ", event_name=" + event_name + ", event_duration=" + event_duration + ", unit_name=" + unit_name
				+ ", unit_email=" + unit_email + ", start_date_time=" + start_date_time + ", end_date_time="
				+ end_date_time + ", record_date=" + record_date + ", client_id=" + client_id + ", client_name="
