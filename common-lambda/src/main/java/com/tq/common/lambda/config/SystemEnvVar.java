...
public class SystemEnvVar implements EnvVar {
    ...
    public SystemEnvVar(Map<String, String> systemEnvironment, Properties properties) {
    ...
    public void setValueSystems(Map<String, String> values) throws NotSupportedException {
        throw new NotSupportedException(this.getClass().toString());
    }
}
