 ...
 */
@WebServlet("/clickfunnel/optin/youtube/created/contact")
public class CFEventCreatedOptInYoutube extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public static final String CONTACT_EVENT_CREATED_RESOURCE = "contact?event=contact-created&optInType=YoutubeOptin";

    /**
     * Default constructor.
     */
    public CFEventCreatedOptInYoutube() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.getWriter().append("Opt-in Youtube");
    }
