...
public interface RecurringOrderInf {
    ...
    public Object getLatestRecurringOrderFromProduct(String apiName, String apiKey, Integer contactId, Integer productId, final List<String> selectedFields) throws InfSDKExecption;
}
