...
public class ContactServiceImpl implements ContactServiceInf {
    ...
    public Object load(String apiName, String apiKey, final LoadContactQuery loaderQuery) throws InfSDKExecption {
        Object result = XmlRqcUtils.execute(apiName, apiKey, new ActionCallback() {
            ...
            public List<?> getParameters(ApiContext apiContext) {
                ...
                params.add(loaderQuery.getSelectedFields());
                return params;
            }
        }, "ContactService.load");
        return result;
    ...
    @Override
    public Object[] findByEmail(String apiName, String apiKey, final SearchEmailQuery emailQuery) throws InfSDKExecption {
    ...
    @Override
    public Integer addWithDupCheck(String apiName, String apiKey, final AddNewContactQuery addQuery) throws InfSDKExecption {
        return (Integer) XmlRqcUtils.execute(apiName, apiKey, new ActionCallback() {
            @Override
            public List<?> getParameters(ApiContext apiContext) {
                List<Object> params = new LinkedList<>();
    ...
    private Boolean makeTagQuery(String apiName, String apiKey, final ApplyTagQuery applyTagQuery, String method) throws InfSDKExecption {
